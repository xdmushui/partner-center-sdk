...
-   App ID creation. Developers who want to integrate Partner Center API/SDK functionality in their app for Partner Center for Microsoft Cloud Germany must register their app ID manually. See [Create apps for Partner Center for Microsoft National Cloud](pc_apiv2.create_apps_for_partner_center_for_microsoft_cloud_germany).
...
-   App ID creation. Developers who want to integrate Partner Center API/SDK functionality in their app for Partner Center for Microsoft Cloud for US Government must register their app ID manually. See [Create apps for Partner Center for Microsoft National Cloud](pc_apiv2.create_apps_for_partner_center_for_microsoft_cloud_germany).
