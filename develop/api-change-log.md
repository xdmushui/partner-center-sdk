...
Changes for October are to support [New commerce licnese-based](/partner-center/develop/purchase-new-commerce-license-based).
...
| Catalog updates for new commerce | New field in public contract | [GET {baseURL}/v1/products/{product-id}/skus/{sku-id}/availabilities?country={country-code}&targetSegment={target-segment}](/partner-center/develop/Get a list of availabilities for a SKU by country - Partner Center app developer | Microsoft Docs) |
