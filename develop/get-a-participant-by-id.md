...
| Method   | Request URI                                                                                                 |
|----------|-------------------------------------------------------------------------------------------------------------|
| **POST** | [*{baseURL}*](partner-center-rest-urls.md)/v2/referrals/{referralId}/participants/{participantId}           |
...
```json
POST https://api.partner.microsoft.com/v2/referrals/{referralId}/participants/{participantId}   HTTP/1.1
