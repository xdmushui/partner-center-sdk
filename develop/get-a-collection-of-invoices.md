...
Note: The same API is used for all modern commercial purchases as well as 145p and office licenses. Size and offset are only considered for legacy invoices. For all modern commercial purchases, pagesize & offset will be ignored.
