...
To find a specific offer by ID, use your **IAggregatePartner.Offers** collection, establish the country withe a call to **ByCountry()**, and then call the [**ByID()**](pc_sdk_offers.ioffercollectionoperations_byid) method. Then, then call the [**Get()**](pc_sdk_offers.ioffercollectionoperations_get) or [**Get Async()**](pc_sdk_offers.ioffercollectionoperations_getasync) method.
