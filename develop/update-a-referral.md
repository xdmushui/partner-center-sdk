...
| Method   | Request URI                                                                                                 |
|----------|-------------------------------------------------------------------------------------------------------------|
| **PUT** | https://api.partnercenter.microsoft.com/referrals/v2/referrals/{Id}                                      |
...
```http
PUT https://api.partnercenter.microsoft.com/referrals/v2/referrals/49d90c72-3326-4f61-aacc-2cb57970448c HTTP/1.1
