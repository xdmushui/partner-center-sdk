# [Partner Center developer resources](index.yml)
...
#### [Customer agreement direct signing (direct acceptance) status](customer-agreement-direct-sign-status-resource.md)
...
#### [Self serve policy](self-serve-policy-resources.md)
