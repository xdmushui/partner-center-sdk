...
To get a customer's billing profile, use your [**IPartner.Customers**](pc_sdk.ipartner_customers) collection and call the [**ById()**](pc_sdk_cust.icustomercollectionoperations_byid) method. Then call the [**Profiles**](pc_sdk_cust.icustomeroperations_profiles) property, followed by the [**Billing**](pc_sdk_cust_prof.icustomerprofilecollectionoperations_billing) property. Finally, call the [**Get()**](pc_sdk_genericops.ientitygetoperations_get) or [**GetAsync()**](pc_sdk_genericops.ientitygetoperations_getasync) methods.
