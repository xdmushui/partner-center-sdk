...
For details on how to reactive an Azure plan, see [reactivate-a-suspended-a-subscription](https://docs.microsoft.com/en-us/partner-center/develop/reactivate-a-suspended-a-subscription)
