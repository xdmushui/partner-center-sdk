...
| refundOptions        | array of [RefundOption](product-resources.md#refundoption) resources | Read-Only. The set of erfund options available under a cancellation policy.                                                                                              |
