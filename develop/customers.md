...
A customer resource represents a customer or reseller. (Most broadly, it can be any person, employee, or organization that wishes to do business with Microsoft and Microsoft's resellers.) Customers also have a company profile and a billing profile.
...
| userCredentials       | [UserCredentials](pc_apiv2.User#usercredentials) | The user credentials.                                                                                                                        |
...
Contains the URL used by the customer to establish a reseller relationship with a partner.
