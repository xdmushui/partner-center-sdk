...
To display a list of all of a customer's service requests, use your **IAggregatePartner.Customers** collection and call the [**ById()**](pc_sdk_cust.icustomercollectionoperations_byid) method. Then call the [**ServiceRequests**](pc_sdk_cust.icustomeroperations_servicerequests) property, followed by the [**Get()**](pc_sdk_genericops.ientitygetoperations_get) or [**GetAsync()**](pc_sdk_genericops.ientitygetoperations_getasync) methods.
