...
<li><p><a href="confirm-customer-consent-customer-agreement.md">Confirm customer acceptance of Microsoft Customer Agreement</a></p></li>
...
<li><p><a href="get-direct-sign-status-of-customer-agreement.md">Get direct signing (direct acceptance) status of Microsoft Customer Agreement</a></p></li>
<li><p><a href="get-customer-agreement-metadata.md">Get agreement metadata for the Microsoft Customer Agreement</a></p></li>
...
<tr>
  <td><p><a href="/partner/develop/referrals">Referrals</a></p></td>
  <td><p>Referrals</p>
    <ul>
      <li><p><a href="/partner/develop/create-a-referral">Create a referral</a></p></li>
      <li><p><a href="/partner/develop/get-a-list-of-referrals">Get a list of referrals</a></p></li>
      <li><p><a href="/partner/develop/get-a-referral-by-id">Get a referral by ID</a></p></li>
      <li><p><a href="/partner/develop/update-a-referral">Update a referral</a></p></li>
    </ul>
  </td>
</tr>
<tr>
...
Subscriptions can be added, and the number of licenses or add-ons can be increased or decreased. If a customer fails to pay, misuses the subscription, or engages in fraud, then Microsoft, the distributor, or the reseller are all able to suspend the subscription. It will be permanent if it's not reactivated within the limits of the CSP program.
