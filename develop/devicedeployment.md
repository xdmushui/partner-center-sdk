...
Describes the status of a device batch upload of information about each device in a list of devices.
...
Provides the information required to create a device batch and populate it with devices.
...
Provides the information required to update a list of devices with a policy.
