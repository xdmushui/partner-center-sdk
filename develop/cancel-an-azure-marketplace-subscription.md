...
description: Cancel an Azure Marketplace Subscription resource that matches the customer and subscription ID.
ms.assetid: 
ms.date: 01/08/2019
...
Cancel an Azure Marketplace [Subscription](subscription-resources.md) resource that matches the customer and subscription ID.
