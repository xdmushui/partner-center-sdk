            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a style="text-decoration: underline; color: var(--primary-base);" href="https://docs.microsoft.com/partner-center/develop/scenarios">How-to guides</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a style="text-decoration: underline; color: var(--primary-base);" href="https://docs.microsoft.com/dotnet/api/?view=partnercenter-dotnet-latest">Partner Center Managed API</a></p>
                        <p><a style="text-decoration: underline; color: var(--primary-base);" href="https://docs.microsoft.com/partner-center/develop/partner-center-rest-api-reference">Partner Center REST API</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a style="text-decoration: underline; color: var(--primary-base);" href="https://apidocs.microsoft.com/services/partnercenter">Partner Center Swagger reference</a></p>
                    </div>
                </div>
            </div>
        </div>
